...
export function MobileLayout({ children, role }: MobileLayoutProps) {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-muted flex flex-col md:items-center md:justify-center md:p-6">
      ...
      <div className="relative flex flex-col w-full h-[100dvh] overflow-hidden bg-background md:w-[390px] md:h-[calc(100dvh-3rem)] md:max-h-[844px] md:rounded-[3rem] md:border-[12px] md:border-neutral-900 md:shadow-2xl md:ring-1 md:ring-black/10">
